...
$t['Let users request withdraws from his wallet. the withdraw mus be done manually'] = 'Pozwól użytkownikom zażądać wypłaty z jego portfela. wypłata musi być dokonana ręcznie';
...
$t['This page works only with MP4,MP3 and OGG-files, if you have or need any other format, try to install your own <a href="https://github.com/WWBN/AVideo-Encoder" class="btn btn-warning btn-xs">encoder</a> or use the <a href="https://encoder1.avideo.com/" class="btn btn-warning btn-xs">public</a> one'] = 'Ta strona działa tylko z plikami MP4, MP3 i OGG, jeśli masz lub potrzebujesz innego formatu, spróbuj zainstalować własny <a href="https://github.com/WWBN/AVideo-Encoder" class="btn btn-warning btn-xs">encoder</a> or use the <a href="https://encoder1.avideo.com/" class="btn btn-warning btn-xs">publiczny</a>';
